    ...
    namespace util
    {
        namespace hash
        {
            ...
            namespace ID
            {
                ...
                constexpr uint32 xxH32         = HGL_MERGE32('x','H','3','2');
                constexpr uint32 xxH64         = HGL_MERGE32('x','H','6','4');
            ...
            */
            ...
            // 向后兼容别名
            template<typename Derived, size_t Size> using HashBase = Base<Derived, Size>;
        ...
        // 向后兼容：直接在 util 命名空间导出主要类型
        using HASH = hash::Algorithm;
        using HashCode = hash::Digest;
        using HashBase = hash::Base;
